...
public class Constantes {
	...
	public static final String ACT1_OBT_AREAS = "Actividad 1. Obtener areas]";
	public static final String ACT1_OBT_AREA = "Actividad 1. Obtener area]";
	public static final String ACT1_CREAR_AREA = "Actividad 1. Crear area]";
	public static final String ACT1_ACTUALIZAR_AREA = "Actividad 1. Actualizar area]";
	public static final String ACT1_ELIMINAR_AREA = "Actividad 1. Eliminar area]";
	...
	public static final String BASE_PATH = "/api/empresa/almacen/area";
	public static final String METODO_LISTAR = "/listarAreas";
	public static final String METODO_BUSCAR = "/buscarArea";
	public static final String METODO_CREAR = "/crearArea";
	public static final String METODO_ACTUALIZAR = "/actualizarArea";
	public static final String METODO_ELIMINAR = "/eliminarArea";
